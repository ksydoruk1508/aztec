...
ok()    { echo -e "${clrGreen}[OK]${clrReset} $1"; }
info()  { echo -e "${clrCyan}[INFO]${clrReset} $1"; }
warn()  { echo -e "${clrYellow}[WARN]${clrReset} $1"; }
err()   { echo -e "${clrRed}[ERROR]${clrReset} $1"; }
...
main_menu() {
  ...
  while true; do
    ...
    echo -e "${clrGreen}4)${clrReset} $(tr m4_logs)"
    echo -e "${clrGreen}5)${clrReset} $(tr m5_sync)"
    echo -e "${clrGreen}6)${clrReset} $(tr m6_rpc)"
    echo -e "${clrGreen}7)${clrReset} $(tr m7_remove)"
    echo -e "${clrGreen}8)${clrReset} $(tr m8_update)"
    echo -e "${clrGreen}9)${clrReset} $(tr m9_showver)"
